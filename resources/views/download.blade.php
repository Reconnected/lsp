    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>Leaflet</td>
                <td>
                    <a href="{{ asset('file/Leaflet.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>2</td>
                <td>Alur Proses Sertifikasi</td>
                <td>
                    <a href="{{ asset('file/Alur Proses Sertifikasi.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>3</td>
                <td>Panduan Uji Kompetensi Skema JOO</td>
                <td>
                    <a href="{{ asset('file/Panduan Uji Kompetensi Skema JOO.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>4</td>
                <td>Panduan Uji Kompetensi Skema JMP</td>
                <td>
                    <a href="{{ asset('file/Panduan Uji Kompetensi Skema JMP.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>5</td>
                <td>Panduan Uji Kompetensi Skema JWD</td>
                <td>
                    <a href="{{ asset('file/Panduan Uji Kompetensi Skema JWD.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>6</td>
                <td>Panduan Uji Kompetensi Skema TUJK</td>
                <td>
                    <a href="{{ asset('file/Panduan Uji Kompetensi Skema TUJK.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>7</td>
                <td>Panduan Uji Kompetensi Skema JNA</td>
                <td>
                    <a href="{{ asset('file/Panduan Uji Kompetensi Skema JNA.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
            <tr>
                <td>8</td>
                <td>Panduan Uji Kompetensi Skema JGD</td>
                <td>
                    <a href="{{ asset('file/Panduan Uji Kompetensi Skema JGD.pdf') }}" download class="btn-download">Download</a>
                </td>
            </tr>
