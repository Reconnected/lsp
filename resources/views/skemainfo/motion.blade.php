...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <img src="{{ asset('../gambar/motion.jpg') }}" alt="Junior Office Specialist">
        </div>

        <!-- Bagian Konten Informasi -->
        <div class="content">
            <h1>MOTION GRAPHIC ARTIST</h1>

            <div class="section">
                <div class="section-title">Deskripsi</div>
                <p>Seorang 3D Animator bertanggung jawab atas berbagai aspek dalam pembuatan animasi
                    tiga dimensi yang berkualitas tinggi. Mereka harus mengaplikasikan prinsip dasar desain dan
                    menerapkan prinsip dasar komunikasi untuk memastikan karya mereka tidak hanya menarik
                    secara visual tetapi juga efektif dalam menyampaikan pesan. Selain itu, mereka membuat
                    pergerakan (motion) objek digital, menciptakan model 3D berbasis hard surface, dan
                    menyusun aset pada bidang 3D untuk menciptakan dunia yang mendalam dan realistis.</p>
            </div>
            ...
            <div class="section">
                ...
                <ul class="requirements">
                    ...
                    <li>Copy sertifikat yang relevan dengan Skema Sertifikasi Motion Graphic Artist, bila ada.</li>
                    <li>CV pengalaman / keterangan kerja yang relevan dengan Skema Sertifikasi Motion
                        Graphic Artist, bila ada.</li>
                    <li>Portofolio yang relevan dengan Skema Sertifikasi Motion Graphic Artist, bila ada.</li>
                </ul>
            </div>
            ...
            <div class="section">
                ...
                <ul>
                    <li><span class="competency-code">M.74100.001.02</span> Mengaplikasikan Prinsip Dasar Desain</li>
                    <li><span class="competency-code">M.74100.002.02</span> Menerapkan Prinsip Dasar Komunikasi</li>
                    <li><span class="competency-code">J.59ANM00.003.2</span> Membuat Pergerakan (Motion) Objek Digital
                    </li>
                    <li><span class="competency-code">J.59ANM01.028.2</span> Membuat Model 3D Berbasis Hard Surface</li>
                    <li><span class="competency-code">J.59ANM01.034.2</span> Membuat Susunan (Layout) Aset Pada Bidang
                        3D</li>
                    <li><span class="competency-code">J.59ANM01.035.2</span> Membuat Artistik Sudut Pandang Kamera 3D
                    </li>
                    <li><span class="competency-code">J.59ANM01.036.2</span> Membuat Artistik Pencahayaan 3D (Set
                        Lighting)</li>
                    <li><span class="competency-code">J.59ANM01.038.2</span> Membuat Penggabungan Aset Visual Teknik
                        Layer 2D (Post 2D
                        Compositing)
                    </li>
                    <li><span class="competency-code">J.59ANM02.051.2</span> Melakukan Penyuntingan Gambar Akhir Animasi
                        (Online Editing)</li>
                    <li><span class="competency-code">J.59ANM03.052.2</span> Membuat Setting-an Sifat Bahan 3D (Shading)
                    </li>
                </ul>
            </div>
