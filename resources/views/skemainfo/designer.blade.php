...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <img src="{{ asset('../gambar/desainer.jpeg') }}" alt="Junior Office Specialist">
        </div>
        ...
        <div class="content">
            ...
            <div class="section">
                ...
                <p>Seorang Desainer Grafis memiliki tanggung jawab yang luas dalam proses penciptaan karya
                    visual. Mereka harus mengaplikasikan prinsip dasar desain untuk memastikan estetika dan
                    fungsionalitas dari hasil karyanya. Selain itu, penerapan prinsip dasar komunikasi sangat
                    penting agar pesan yang ingin disampaikan melalui desain dapat diterima dengan jelas
                    oleh audiens.</p>
            </div>
            ...
            <div class="section">
                ...
                <ul class="requirements">
                    ...
                    <li>Copy sertifikat yang relevan dengan Skema Sertifikasi Junior Graphic Designer, bila ada.</li>
                    <li>CV pengalaman / keterangan kerja yang relevan dengan Skema Sertifikasi Junior Graphic
                        Designer, bila ada.</li>
                    <li>Portofolio yang relevan dengan Skema Sertifikasi Junior Graphic Designer, bila ada.</li>
                </ul>
            </div>
            ...
            <div class="section">
                ...
                <ul>
                    <li><span class="competency-code">M.74100.001.02</span> Mengaplikasikan prinsip dasardesain</li>
                    <li><span class="competency-code">M.74100.002.02</span> Menerapkan prinsip dasarkomunikasi</li>
                    <li><span class="competency-code">M.74100.005.02</span> Menerapkan design brief</li>
                    <li><span class="competency-code">M.74100.009.02</span> Mengoperasikan perangkat lunakdesain</li>
                    <li><span class="competency-code">M.74100.010.01</span> Menciptakan karya desain</li>
                </ul>
            </div>
