...
<body>
    ...
    <div class="container">
        ...
        <div class="header">
            <img src="{{ asset('../gambar/administrator.jpg') }}" alt="Junior Office Specialist">
        </div>

        <!-- Bagian Konten Informasi -->
        <div class="content">
            <h1>JUNIOR NETWORK ADMINISTRATOR</h1>

            <div class="section">
                <div class="section-title">Deskripsi</div>
                <p>Seorang Network Engineer memiliki tanggung jawab penting dalam memastikan kelancaran
                    dan keamanan jaringan. Mereka merancang pengalamatan jaringan untuk memastikan
                    setiap perangkat dapat berkomunikasi dengan benar. Pemasangan jaringan nirkabel adalah
                    salah satu tugas mereka, yang melibatkan penempatan dan konfigurasi perangkat untuk
                    cakupan dan kinerja optimal.</p>
            </div>
            ...
            <div class="section">
                ...
                <ul class="requirements">
                    ...
                    <li>Copy sertifikat yang relevan dengan Skema Sertifikasi Junior Netword Administrator, bila
                        ada.</li>
                    <li>CV pengalaman / keterangan kerja yang relevan dengan Skema Sertifikasi Junior
                        Netword Administrator, bila ada.</li>
                    <li>Portofolio yang relevan dengan Skema Sertifikasi Junior Netword Administrator, bila ada.                        .</li>
                </ul>
            </div>
            ...
            <div class="section">
                ...
                <ul>
                    ...
                    <li><span class="competency-code">J.611000.012.02</span> Mengkonfigurasi Switch pada Jaringan</li>
                    <li><span class="competency-code">J.611000.013.02</span> Mengkonfigurasi Routingpada Perangkat Jaringan dalam Satu
